class ProductsController < ApplicationController
  ...
  def create
    ...
    if @product.save
      ...
      redirect_back(fallback_location: root_path, notice: "商品创建成功！")
    else
      redirect_back(fallback_location: root_path, notice: "商品创建失败！")
    end
  end
  ...
  def update
    if @product.update(product_params)
      redirect_back(fallback_location: root_path, notice: "商品更新成功！")
    else
      redirect_back(fallback_location: root_path, notice: "商品更新失败！")
    end
  end
